...
[![Gen-2k's GitHub Stats](https://github-readme-stats.vercel.app/api?username=Gen-2k&show_icons=true&count_private=true&theme=react&hide_border=true&border_radius=10)](https://github.com/Gen-2k)
...
### [Project_X](https://github.com/Gen-2k/Project_X) — Enterprise Monorepo
...
![React 19](https://img.shields.io/badge/React-19.x-cyan.svg)
![NestJS](https://img.shields.io/badge/NestJS-11.x-red.svg)
![Prisma](https://img.shields.io/badge/Prisma-7.x-black.svg)

> Production-grade **TypeScript monorepo** featuring a React 19 + Vite client, NestJS 11 + Prisma 7 API,
> strict quality gates, and automated CI/CD — powered by Turborepo & pnpm.

| Component | Stack |
|-----------|-------|
| 🖥️ **Client** | React 19 · Vite 8 · Vitest |
| ⚙️ **Server** | NestJS 11 · Prisma 7 · Jest |
| 📦 **Packages** | ESLint configs · TS configs · Shared DTOs |
| 🚀 **CI/CD** | GitHub Actions · Docker · pnpm |
...
**💼 Open to freelance work & collaborations** — let's build something great together.
